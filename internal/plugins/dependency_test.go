...
func (m *MockDependencyPlugin) Install(kubeConfig, clusterName string, ensure ...bool) error { return nil }
func (m *MockDependencyPlugin) Uninstall(kubeConfig, clusterName string, ensure ...bool) error { return nil }
